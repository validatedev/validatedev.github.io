...
if ( ! function_exists( 'selfgraphy_sanitize_select' ) ) :
	/**
	 ...
	 */
	function selfgraphy_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'selfgraphy_sanitize_image' ) ) :
	/**
	 ...
	 */
	function selfgraphy_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'selfgraphy_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function selfgraphy_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'selfgraphy_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Selfgraphy 1.0.0
	*/
	function selfgraphy_sanitize_page( $input ) {
...
if ( ! function_exists( 'selfgraphy_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Selfgraphy 1.0.0
	 ...
	 */
	function selfgraphy_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'selfgraphy_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Selfgraphy 1.0.0
	 */
	function selfgraphy_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'selfgraphy_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Selfgraphy 1.0.0
	 */
	function selfgraphy_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'selfgraphy_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function selfgraphy_santize_allow_tag( $input ) {
 ...
 * @return boolean    
 */
function selfgraphy_sanitize_switch_control( $input ) {
