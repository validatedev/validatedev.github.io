 ...
 */
class Selfgraphy_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Selfgraphy_Dropdown_Category_Control extends WP_Customize_Control {
...
class Selfgraphy_Note_Control extends WP_Customize_Control {
...
class Selfgraphy_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Selfgraphy_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="selfgraphy-chosen-select" <?php $this->link(); ?>>
                    <?php
 ...
 */
class Selfgraphy_Custom_Radio_Image_Control extends WP_Customize_Control {
...
Class Selfgraphy_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
