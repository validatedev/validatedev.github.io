...
class Selfgraphy_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'selfgraphy';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'selfgraphy' ), $i ),
...
// Initialize.
$selfgraphy_footer_widgets = new Selfgraphy_Footer_Widgets();
